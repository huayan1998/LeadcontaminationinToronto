...
# 3: Results
Our analysis of the lead levels in Toronto's drinking water reveals significant insights, as demonstrated in the visualizations.
##3.1 Distribution of Lead Levels
 
Figure 1: Distribution of Lead Levels
The histogram of lead levels in Toronto's tap water (Figure 1) displays a right-skewed distribution, with the majority of the water samples containing very low levels of lead, close to zero. A considerable frequency of samples indicates non-detectable lead levels, aligning with the leftmost bar of the histogram. However, there is a long tail towards higher lead amounts, suggesting that a minority of samples contain elevated lead levels. This tail extends towards levels that are concerning, particularly those samples which exceed the 0.010 ppm threshold set by Ontario's regulations. This distribution indicates that while most of the water supply meets safety standards, there is a subset of the population that may be exposed to unsafe lead levels.

##3.2 Time Series of Lead Levels
 
Figure 2: Time Series Plot
The time series plot (Figure 2) presents the lead levels from January 2014 to January 2024. The plot shows variability over time with no clear upward or downward trend, implying that significant changes in lead levels have not occurred throughout this period. Spikes in lead concentration are observed intermittently, which could correspond to specific events or changes in the water supply system that require further investigation. The absence of a trend suggests that while lead contamination incidents occur, they are not increasing or decreasing systematically over time.

#4: Conclusion 

The analysis of lead levels in Toronto's drinking water finds that, although the majority of samples meet safety guidelines, a fraction had excessive lead levels. The time series data shows no discernible pattern, although sporadic spikes indicate localised or transitory contamination occurrences. These results highlight the need for continued monitoring and cleanup efforts, especially in older neighbourhoods with lead service lines. To address this challenge, public health measures and infrastructural investments must continue. It is also vital to ensure that households are informed about lead testing programmes and actively participate. Finally, consistent monitoring and proactive public policies are required to provide safe drinking water for all Toronto residents, thereby safeguarding public health and maintaining the city's livability.
